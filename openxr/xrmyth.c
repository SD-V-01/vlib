...
char* vtostr8_XrLipExpressionHTC(XrLipExpressionHTC In){
    ...
    case(XR_LIP_EXPRESSION_MOUTH_SMILE_RIGHT_HTC):
        return "XR_LIP_EXPRESSION_MOUTH_SMILE_RIGHT_HTC";
        break;
    case(XR_LIP_EXPRESSION_MOUTH_SMILE_LEFT_HTC):
        return "XR_LIP_EXPRESSION_MOUTH_SMILE_LEFT_HTC";
        break;
    case(XR_LIP_EXPRESSION_MOUTH_SAD_RIGHT_HTC):
        return "XR_LIP_EXPRESSION_MOUTH_SAD_RIGHT_HTC";
        break;
    case(XR_LIP_EXPRESSION_MOUTH_SAD_LEFT_HTC):
        return "XR_LIP_EXPRESSION_MOUTH_SAD_LEFT_HTC";
        break;
...
vchar* vtostr32_XrLipExpressionHTC(XrLipExpressionHTC In){
    ...
    case(XR_LIP_EXPRESSION_MOUTH_POUT_HTC):
        ...
        break;
    case(XR_LIP_EXPRESSION_MOUTH_SMILE_RIGHT_HTC):
        return U"XR_LIP_EXPRESSION_MOUTH_SMILE_RIGHT_HTC";
        break;
    case(XR_LIP_EXPRESSION_MOUTH_SMILE_LEFT_HTC):
        return U"XR_LIP_EXPRESSION_MOUTH_SMILE_LEFT_HTC";
        break;
    case(XR_LIP_EXPRESSION_MOUTH_SAD_RIGHT_HTC):
        return U"XR_LIP_EXPRESSION_MOUTH_SAD_RIGHT_HTC";
        break;
    case(XR_LIP_EXPRESSION_MOUTH_SAD_LEFT_HTC):
        return U"XR_LIP_EXPRESSION_MOUTH_SAD_LEFT_HTC";
        break;
    case(XR_LIP_EXPRESSION_CHEEK_PUFF_RIGHT_HTC):
